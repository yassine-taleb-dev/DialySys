...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-TMY26D5L.js").then((m) => m.LoginComponent)
  },
  {
    path: "medecin",
    loadComponent: () => import("./chunk-SSWTE4AE.js").then((m) => m.MedecinComponent),
    canActivate: [authGuard],
    data: { roles: ["MEDECIN"] }
  },
  {
    path: "infirmier",
    loadComponent: () => import("./chunk-YFHEIOSR.js").then((m) => m.InfirmierComponent),
    canActivate: [authGuard],
    data: { roles: ["INFIRMIER"] }
  },
  {
    path: "infirmier-majeur",
    loadComponent: () => import("./chunk-PHSLW3FC.js").then((m) => m.InfirmierMajeurComponent),
    canActivate: [authGuard],
    data: { roles: ["INFIRMIER_MAJEUR"] }
  },
  {
    path: "aide-soignant",
    loadComponent: () => import("./chunk-2HOT6FJA.js").then((m) => m.AideSoignantComponent),
    canActivate: [authGuard],
    data: { roles: ["AIDE_SOIGNANT"] }
  },
  {
    path: "patient",
    loadComponent: () => import("./chunk-ZY7WR5BQ.js").then((m) => m.PatientComponent),
    canActivate: [authGuard],
    data: { roles: ["PATIENT"] }
  },
  {
    path: "planning",
    loadComponent: () => import("./chunk-6HP2UGEI.js").then((m) => m.PlanningComponent),
    canActivate: [authGuard],
    data: { roles: ["MEDECIN", "INFIRMIER", "INFIRMIER_MAJEUR", "AIDE_SOIGNANT"] }
  },
  {
    path: "admin",
    loadComponent: () => import("./chunk-FV4CTV6X.js").then((m) => m.AdminComponent),
    canActivate: [authGuard],
    data: { roles: ["ADMIN"] }
  },
  {
