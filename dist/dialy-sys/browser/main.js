...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-FGXAGKNM.js").then((m) => m.LoginComponent)
  },
  {
    path: "medecin",
    loadComponent: () => import("./chunk-AOJM2PJU.js").then((m) => m.MedecinComponent),
    canActivate: [authGuard],
    data: { roles: ["MEDECIN"] }
  },
  {
    path: "infirmier-majeur",
    loadComponent: () => import("./chunk-3Y2B5SFP.js").then((m) => m.InfirmierMajeurComponent),
    canActivate: [authGuard],
    data: { roles: ["INFIRMIER_MAJEUR"] }
  },
  {
    path: "infirmier",
    loadComponent: () => import("./chunk-QJI2PCUI.js").then((m) => m.InfirmierComponent),
    canActivate: [authGuard],
    data: { roles: ["AIDE_SOIGNANT", "INFIRMIER"] }
  },
  {
    path: "patient",
    loadComponent: () => import("./chunk-G3KAQXIS.js").then((m) => m.PatientComponent),
    canActivate: [authGuard],
    data: { roles: ["PATIENT"] }
  },
  {
    path: "planning",
    loadComponent: () => import("./chunk-6MTBHHY5.js").then((m) => m.PlanningComponent),
    canActivate: [authGuard],
    data: { roles: ["MEDECIN", "INFIRMIER_MAJEUR", "AIDE_SOIGNANT", "INFIRMIER"] }
  },
  {
    path: "admin",
    loadComponent: () => import("./chunk-HXFML3Y6.js").then((m) => m.AdminComponent),
    canActivate: [authGuard],
    data: { roles: ["ADMIN"] }
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-KAOPHHTB.js").then((m) => m.UnauthorizedComponent)
  },
