...
function PlanningComponent_div_3_option_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 75);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.formatHour(h_r7));
  }
}
function PlanningComponent_div_3_option_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 75);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const aide_r8 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("value", aide_r8.aideSoignant.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.aideNom(aide_r8), " ");
  }
}
function PlanningComponent_div_3_div_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 83);
    \u0275\u0275text(1, " Aucune aide-soignante disponible \xE0 cette date. ");
    \u0275\u0275elementEnd();
  }
}
function PlanningComponent_div_3_div_62_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 86)(1, "span", 13);
    \u0275\u0275text(2, "schedule");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const horaire_r9 = ctx.$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2("", horaire_r9.heureDebut, " - ", horaire_r9.heureFin, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(horaire_r9.utilisateurNom);
  }
}
function PlanningComponent_div_3_div_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 73)(1, "label");
    \u0275\u0275text(2, "Horaires de travail");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 84);
    \u0275\u0275template(4, PlanningComponent_div_3_div_62_div_4_Template, 7, 3, "div", 85);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 83);
    \u0275\u0275text(6, " L'heure de d\xE9but et la dur\xE9e sont remplies automatiquement depuis cet horaire. ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx_r2.selectedAideHoraires());
  }
}
function PlanningComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "Planifier une s\xE9ance de dialyse");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21, "Date souhait\xE9e");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "input", 77);
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_input_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.newSeance.date, $event) || (ctx_r2.newSeance.date = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function PlanningComponent_div_3_Template_input_ngModelChange_22_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onNewSeanceDateChange());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 76)(24, "label");
    \u0275\u0275text(25, "Heure de d\xE9but");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "select", 23);
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_select_ngModelChange_26_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.newSeance.hour, $event) || (ctx_r2.newSeance.hour = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(27, PlanningComponent_div_3_option_27_Template, 2, 2, "option", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 76)(29, "label");
    \u0275\u0275text(30, "Minutes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "select", 23);
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_select_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.newSeance.minute, $event) || (ctx_r2.newSeance.minute = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(32, "option", 75);
    \u0275\u0275text(33, ":00");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "option", 75);
    \u0275\u0275text(35, ":30");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_select_ngModelChange_39_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(47, "4h30");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(48, "div", 76)(49, "label");
    \u0275\u0275text(50, "Machine ");
    \u0275\u0275elementStart(51, "span", 74);
    \u0275\u0275text(52, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(53, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_input_ngModelChange_53_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 73)(55, "label");
    \u0275\u0275text(56, "Aide-soignante disponible");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "select", 79);
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_select_ngModelChange_57_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.newSeance.aideSoignantId, $event) || (ctx_r2.newSeance.aideSoignantId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function PlanningComponent_div_3_Template_select_ngModelChange_57_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onAideSoignantChange());
    });
    \u0275\u0275elementStart(58, "option", 75);
    \u0275\u0275text(59);
    \u0275\u0275elementEnd();
    \u0275\u0275template(60, PlanningComponent_div_3_option_60_Template, 2, 2, "option", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275template(61, PlanningComponent_div_3_div_61_Template, 2, 0, "div", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275template(62, PlanningComponent_div_3_div_62_Template, 7, 1, "div", 81);
    \u0275\u0275elementStart(63, "div", 73)(64, "label");
    \u0275\u0275text(65, "Notes (optionnel)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "textarea", 82);
    \u0275\u0275twoWayListener("ngModelChange", function PlanningComponent_div_3_Template_textarea_ngModelChange_66_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(67, "div", 67)(68, "button", 46);
    \u0275\u0275listener("click", function PlanningComponent_div_3_Template_button_click_68_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(71, " Planifier la s\xE9ance ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "button", 68);
    \u0275\u0275listener("click", function PlanningComponent_div_3_Template_button_click_72_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showNewModal = false);
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.newSeance.date);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.newSeance.aideSoignantId);
    \u0275\u0275property("disabled", ctx_r2.isLoadingAides || ctx_r2.aidesDisponibles.length === 0);
    \u0275\u0275advance();
    \u0275\u0275property("value", 0);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.isLoadingAides ? "Chargement..." : "\u2014 S\xE9lectionner une aide-soignante \u2014", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r2.aidesDisponibles);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.isLoadingAides && ctx_r2.newSeance.date && ctx_r2.aidesDisponibles.length === 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.selectedAideHoraires().length > 0);
    \u0275\u0275advance(4);
...
function PlanningComponent_div_132_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 88)(1, "span", 13);
    \u0275\u0275text(2, "filter_alt");
    \u0275\u0275elementEnd();
...
function PlanningComponent_div_134_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, PlanningComponent_div_134_div_3_span_5_Template, 2, 2, "span", 103);
...
function PlanningComponent_div_134_div_7_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 116)(6, "span", 13);
...
function PlanningComponent_div_134_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, PlanningComponent_div_134_div_7_div_1_Template, 1, 2, "div", 108)(2, PlanningComponent_div_134_div_7_div_2_Template, 1, 2, "div", 109)(3, PlanningComponent_div_134_div_7_div_3_Template, 11, 11, "div", 110)(4, PlanningComponent_div_134_div_7_div_4_Template, 1, 0, "div", 111);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PlanningComponent_div_134_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 119)(1, "span", 13);
    \u0275\u0275text(2, "event_busy");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
...
function PlanningComponent_div_134_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "div", 93);
    \u0275\u0275template(3, PlanningComponent_div_134_div_3_Template, 9, 9, "div", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 95)(5, "div", 96);
    \u0275\u0275template(6, PlanningComponent_div_134_div_6_Template, 2, 3, "div", 97);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, PlanningComponent_div_134_div_7_Template, 5, 10, "div", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, PlanningComponent_div_134_div_8_Template, 9, 0, "div", 99);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function PlanningComponent_div_135_div_1_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 135)(1, "span", 13);
    \u0275\u0275text(2, "event_busy");
    \u0275\u0275elementEnd();
...
function PlanningComponent_div_135_div_1_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 137)(2, "span", 138);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 139);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(6, "div", 140);
    \u0275\u0275elementStart(7, "div", 141)(8, "div", 142);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
...
function PlanningComponent_div_135_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, PlanningComponent_div_135_div_1_span_4_Template, 2, 0, "span", 125)(5, PlanningComponent_div_135_div_1_span_5_Template, 2, 0, "span", 126)(6, PlanningComponent_div_135_div_1_span_6_Template, 2, 0, "span", 127);
    \u0275\u0275elementStart(7, "span", 128);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 129);
    ...
    \u0275\u0275text(12, " Ajouter ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, PlanningComponent_div_135_div_1_div_13_Template, 4, 0, "div", 130)(14, PlanningComponent_div_135_div_1_div_14_Template, 19, 11, "div", 131);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PlanningComponent_div_135_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, PlanningComponent_div_135_div_1_Template, 15, 10, "div", 121);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
