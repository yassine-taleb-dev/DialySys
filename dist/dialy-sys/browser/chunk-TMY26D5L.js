...
function LoginComponent_form_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Matricule / Identifiant");
    \u0275\u0275elementEnd();
...
@media (max-width: 768px) {
  ...
  .brand[_ngcontent-%COMP%]   .brand__tag[_ngcontent-%COMP%] {
    font-size: 10px;
    padding: 3px 10px;
  }
  .ecg-strip[_ngcontent-%COMP%] {
...
//# sourceMappingURL=chunk-TMY26D5L.js.map
