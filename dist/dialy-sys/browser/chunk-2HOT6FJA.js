...
function AideSoignantComponent_div_2_div_24_div_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 72)(10, "span", 14);
    \u0275\u0275text(11, "person");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(o_r6.medicament);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(o_r6.posologie);
    \u0275\u0275advance(4);
...
function AideSoignantComponent_div_2_div_24_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AideSoignantComponent_div_2_div_24_div_2_div_1_Template, 18, 4, "div", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AideSoignantComponent_div_2_div_25_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 98)(1, "span", 14);
    \u0275\u0275text(2, "favorite");
    \u0275\u0275elementEnd();
...
function AideSoignantComponent_div_2_div_25_div_65_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 104)(1, "span", 14);
    \u0275\u0275text(2, " favorite ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function AideSoignantComponent_div_2_div_25_div_65_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AideSoignantComponent_div_2_div_25_div_65_div_1_Template, 4, 1, "div", 102)(2, AideSoignantComponent_div_2_div_25_div_65_div_2_Template, 4, 5, "div", 103);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function AideSoignantComponent_div_2_div_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 59)(1, "div", 74)(2, "div", 75)(3, "span", 76);
    \u0275\u0275text(4, "bloodtype");
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, " Tension arterielle ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 77)(7, "div", 78)(8, "label");
    \u0275\u0275text(9, "Systolique ");
    \u0275\u0275elementStart(10, "span", 79);
    \u0275\u0275text(11, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 80)(13, "input", 81);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 83)(19, "span");
    \u0275\u0275text(20, "/");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(25, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 80)(27, "input", 84);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "span", 82);
    \u0275\u0275text(29, "mmHg");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "small");
    \u0275\u0275text(31, "Normale : 60 - 90");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(32, AideSoignantComponent_div_2_div_25_div_32_Template, 7, 8, "div", 85);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 74)(34, "div", 75)(35, "span", 86);
    \u0275\u0275text(36, "vital_signs");
    \u0275\u0275elementEnd();
    \u0275\u0275text(37, " Mesures physiques ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 77)(39, "div", 87)(40, "label")(41, "span", 88);
    ...
    \u0275\u0275text(45, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 80)(47, "input", 89);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "span", 82);
    \u0275\u0275text(49, "kg");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(50, "small");
    \u0275\u0275text(51, "Avant seance");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 87)(53, "label")(54, "span", 90);
    \u0275\u0275text(55, "favorite");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(58, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "div", 80)(60, "input", 91);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "span", 82);
    \u0275\u0275text(62, "bpm");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(63, "small");
    \u0275\u0275text(64, "Normale : 60 - 100 bpm");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(65, AideSoignantComponent_div_2_div_25_div_65_Template, 3, 2, "div", 92);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "div", 74)(67, "div", 75)(68, "span", 93);
    \u0275\u0275text(69, "notes");
    \u0275\u0275elementEnd();
    \u0275\u0275text(70, " Observations ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "textarea", 94);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 95)(73, "button", 96);
...
function AideSoignantComponent_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("Machine ", ctx_r2.selectedPatient.machine, " \uFFFD ", ctx_r2.selectedPatient.heureDebut, " - ", ctx_r2.selectedPatient.heureFin, "");
    \u0275\u0275advance();
...
function AideSoignantComponent_ng_container_83_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, AideSoignantComponent_ng_container_83_div_2_span_3_Template, 1, 0, "span", 112);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const cell_r10 = \u0275\u0275nextContext().$implicit;
...
function AideSoignantComponent_ng_container_83_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AideSoignantComponent_ng_container_83_div_1_Template, 1, 0, "div", 107)(2, AideSoignantComponent_ng_container_83_div_2_Template, 4, 10, "div", 108);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AideSoignantComponent_div_95_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 114)(1, "span", 14);
...
function AideSoignantComponent_div_96_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 115)(8, "span", 14);
    \u0275\u0275text(9, "event_note");
    \u0275\u0275elementEnd();
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
...
function AideSoignantComponent_ng_container_98_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 127)(9, "span", 14);
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 128)(18, "span", 14);
    \u0275\u0275text(19, "schedule");
    \u0275\u0275elementEnd();
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 129)(22, "span", 100);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 130)(25, "span", 14);
    \u0275\u0275text(26, "open_in_new");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function AideSoignantComponent_ng_container_98_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 116)(2, "div", 117)(3, "span", 14);
    \u0275\u0275text(4, "event");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(10, AideSoignantComponent_ng_container_98_div_10_Template, 27, 9, "div", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 121)(12, "span", 14);
    \u0275\u0275text(13, "touch_app");
    \u0275\u0275elementEnd();
